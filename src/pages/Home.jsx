    ...
    <div className="relative min-h-screen" style={{ backgroundColor: "var(--site-bg)", color: "var(--ink)", ...fontDisplay }}>
      ...
      <header className="fixed top-0 left-0 right-0 flex items-center justify-between"
        ...
        <nav className="flex" style={{ gap: "clamp(16px, 3vw, 28px)" }}>
          ...
          <a href="/events" style={{ ...fontDisplay, fontWeight: 500, fontSize: "clamp(12px, 2.5vw, 14px)", letterSpacing: "0.01em", color: "rgba(var(--ink-rgb), 0.85)", textDecoration: "none", transition: "color 0.2s" }} onMouseEnter={(e) => e.target.style.color = "var(--accent)"} onMouseLeave={(e) => e.target.style.color = "rgba(var(--ink-rgb), 0.85)"}>Events</a>
