...
export default function Home({ initialView = "home" }) {
  ...
  const vendors = [
    { name: "1Fort", category: "Commercial Lines", since: "07·26", thumb: "https://media.base44.com/images/public/6a037576ebf42363ca2506d2/91bffa08e_ChatGPTImageJul132026at09_01_12AM.png", thumbBg: "#ffffff", thumbFit: "contain" },
