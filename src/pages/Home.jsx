...
export default function Home({ initialView = "home" }) {
  ...
  const vendors = [
    { name: "1Fort", category: "Commercial Lines", since: "07·26", thumb: "https://base44.app/api/apps/6a037576ebf42363ca2506d2/files/mp/public/6a037576ebf42363ca2506d2/3cc89497b_1fort-transparent-v3.png", thumbFit: "contain" },
