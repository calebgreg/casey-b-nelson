...
export default function Home({ initialView = "home" }) {
  ...
  const vendors = [
    { name: "1Fort", category: "Commercial Lines", since: "07·26", thumb: "https://base44.app/api/apps/6a037576ebf42363ca2506d2/files/mp/public/6a037576ebf42363ca2506d2/5adc2fd9f_1fort-transparent.png", thumbFit: "contain" },
