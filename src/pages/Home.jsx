...
export default function Home({ initialView = "home" }) {
  ...
  const vendors = [
    { name: "1Fort", category: "Commercial Lines", since: "07·26", thumbCss: { backgroundImage: "url(https://media.base44.com/images/public/6a037576ebf42363ca2506d2/66a082813_1fort.png)", backgroundColor: "#ffffff", backgroundRepeat: "no-repeat", backgroundSize: "auto 56px", backgroundPosition: "32px center" } },
