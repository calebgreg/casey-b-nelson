  ...
  return (
    <div className="relative min-h-screen" style={{ backgroundColor: "#0A0A0A", color: "#F0EBE0", ...fontDisplay }}>
      ...
      <div style={{ marginBottom: "clamp(48px, 6vw, 72px)" }}>
        <h2 style={{ ...fontDisplay, fontWeight: 900, fontSize: "clamp(56px, 11vw, 140px)", lineHeight: 0.92, letterSpacing: "-0.04em", margin: 0, color: "#F0EBE0", marginBottom: 32 }}>
          Request Casey to speak.
        </h2>
        <p style={{ ...fontDisplay, fontSize: "clamp(17px, 1.3vw, 19px)", lineHeight: 1.55, color: "rgba(240, 235, 224, 0.62)", maxWidth: 600 }}>
      ...
      <div className="grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "clamp(32px, 4vw, 60px)", marginBottom: "clamp(60px, 8vw, 100px)" }}>
        {[
          ...
          <div key={group.label}>
            <div style={{ ...fontDisplay, fontWeight: 600, fontSize: "clamp(16px, 1.4vw, 19px)", color: "#F0EBE0", marginBottom: 14, letterSpacing: "-0.01em" }}>{group.label}</div>
            <ul style={{ ...fontDisplay, fontSize: 15, lineHeight: 1.7, color: "rgba(240, 235, 224, 0.7)", margin: 0, paddingLeft: 0, listStyle: "none" }}>
      ...
      {!form.submitted ? (
        <form onSubmit={handleSubmit} className="grid gap-8" style={{ maxWidth: 640 }}>
          <div>
            <label className="block" style={{ ...fontDisplay, fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6B6760", marginBottom: 8 }}>Your organization</label>
          ...
          <div>
            <label className="block" style={{ ...fontDisplay, fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6B6760", marginBottom: 8 }}>Event name & location</label>
          ...
          <div>
            <label className="block" style={{ ...fontDisplay, fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6B6760", marginBottom: 8 }}>Date or timeframe</label>
          ...
          <div>
            <label className="block" style={{ ...fontDisplay, fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6B6760", marginBottom: 8 }}>Audience size & profile</label>
          ...
          <div>
            <label className="block" style={{ ...fontDisplay, fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6B6760", marginBottom: 8 }}>Anything else we should know</label>
            <textarea value={form.note} onChange={(e) => setForm({ ...form, note: e.target.value })} placeholder="Format, topic angle, logistics, budget…"
              style={{ background: "transparent", border: "1px solid rgba(240, 235, 224, 0.12)", ...fontDisplay, fontSize: 16, color: "#F0EBE0", padding: 16, outline: "none", width: "100%", minHeight: 100, resize: "vertical", lineHeight: 1.5 }} />
          </div>
        ...
        <div style={{ maxWidth: 640 }}>
          ...
          <p style={{ ...fontDisplay, fontSize: 18, lineHeight: 1.55, color: "rgba(240, 235, 224, 0.72)" }}>Casey will review and get back to you within a week with availability and next steps. If the timing and topic align, you'll hear directly.</p>
        </div>
      )}
    </section>
      </main>
